...
export default function Product() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      ...
      let index = newFilter[section.id].find((el) => el === option.value);
  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <MobileFilter handleFilter={handleFilter} />
...
const ProductGrid = ({ products }) => {
  return (
    <div className="lg:col-span-3">
      {" "}
      <div className="bg-white">
        <div className="mx-auto max-w-2xl border bottom-3 px-4 py-2 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-8">
